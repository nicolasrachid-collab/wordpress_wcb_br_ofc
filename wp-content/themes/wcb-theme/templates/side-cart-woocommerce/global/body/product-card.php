<?php
/**
 * Product Card (WCB Theme Override)
 *
 * Layout 3 colunas alinhado à referência “Meu carrinho”:
    ...
    <div class="<?php echo esc_attr( $wcb_card_info_class ); ?>">
        <?php if ( $showPname ) : ?>
            <div class="wcb-card-title-row">
                <span class="xoo-wsc-pname" title="<?php echo esc_attr($wcb_pname_plain); ?>"><?php echo $product_name; ?></span>
            </div>
        <?php endif; ?>
